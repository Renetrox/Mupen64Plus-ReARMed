...
struct retro_core_option_v2_definition option_defs_us[] = {
    {
        ...
        "Frame Skip",
        NULL,
        "Renderer-independent automatic HLE graphics frameskip. Auto skips graphics work only when the emulator falls behind and keeps CPU/audio emulation running. Requires the HLE RSP. For renderer-specific forced skipping, use the renderer's own option.",
        NULL,
        NULL,
        {
            {"disabled", "Disabled"},
